 ...
 return (
   <div>
     ...
     <div className='lg:px-40 px-5 py-20'>
       ...
       <p>Welcome to VedicSansar, your one-stop destination for quality, convenience, and innovation in online shopping.</p>
       ...
       <p className='mt-3'>
       Thank you for choosing VedicSansar. Let&apos;s make shopping smarter, simpler, and more enjoyable—together.
       </p>
     </div>
   </div>
 )
