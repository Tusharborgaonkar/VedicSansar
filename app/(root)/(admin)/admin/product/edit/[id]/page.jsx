...
const EditProduct = ({params}) => {
    ...
    const {data : getCategory} = useFetch('/api/category?deleteType=SD&&size=10000');//10000 category
                              ...
                              <form onSubmit={form.handleSubmit(onSubmit)}  >
                                ...
                                <div className='grid md:grid-cols-2 grid-cols-1  gap-5'>
                                  ...
                                  <div className='mb-3 mt-5'>
                                    <ButtonLoading loading={loading} type="submit" text = "Save Changes" className='text-xm text-white font-semibold cursor-pointer hover:bg-amber-600' />
                                  </div>
