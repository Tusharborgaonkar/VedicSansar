  ...
  return (
    <div>
      ...
      <UserPanelLayout>
          ...
          <div className='p-5 text-xl font-semibold border-b text-amber-900'>
            My Profile
          </div>
            ...
            <Form {...form}>
                        <form className='grid md:grid-cols-2 grid-cols-1 gap-5' onSubmit={form.handleSubmit(updateProfile)} >
                          ...
                          <div className='md:col-span-2 col-span-1 flex justify-center items-center'>
                                ...
                                {({getRootProps, getInputProps}) => (
                                    ...
                                    <div {...getRootProps()}>
                                      ...
                                      <Avatar className="w-28 h-28 relative group border border-gray-100">
                                        ...
                                        <div className="absolute z-50 w-full h-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-center items-center border-2 border-amber-800 rounded-full group-hover:flex hidden cursor-pointer bg-black/20" >
                            ...
                            <div className='mb-3 md:col-span-2 col-span-1'>
                              <ButtonLoading loading={loading} type="submit" text = "Update Profile" className=' text-xm text-white font-semibold cursor-pointer bg-amber-900 hover:bg-amber-800' />
                            </div>
