...
const Filter = () => {
    ...
    const [priceFilter, setPriceFilter] = useState({minPrice: 0, maxPrice:50000});
    ...
    // to maintain selection even after page refresh
    useEffect(()=>{
    ...
    const handleCategoryFilter = (categorySlug)=>{
        ...
        ?
        urlSearchParams.set('category', newSelectedCategory.join(',')) : urlSearchParams.delete('category');
    ...
    const handleColorFilter = (color)=>{
        ...
        ?
        urlSearchParams.set('color', newSelectedColor.join(',')) : urlSearchParams.delete('color');
    ...
    const handleSizeFilter = (size)=>{
        ...
        ?
        urlSearchParams.set('size', newSelectedSize.join(',')) : urlSearchParams.delete('size');
  ...
  return (
    <div>
        {searchParams.size > 0 && 
            <Button type="button" className="w-full bg-orange-900 hover:bg-orange-800" asChild >
      ...
      <Accordion type="multiple" defaultValue={['1','2','3','4']}>
        ...
        <AccordionItem value="4">
            ...
            <AccordionContent>
               <Slider defaultValue={[0 , 50000]} max={50000} step={1} onValueChange={handlePriceChange} />
