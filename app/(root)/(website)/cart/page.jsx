                  ...
                  <tr key={product.variantId} className='md:table-row block border-b'>
                    <td className='p-3'>
                      <div className='flex items-center gap-5'>
                        ...
                        <div>
                          <h4 className='text-lg font-medium line-clamp-1'><Link href={WEBSITE_PRODUCT_DETAILS(product.url)}>
                            {product.name}
                          </Link></h4>
                    ...
                    <td className='md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center'>
                        ...
                        <span className='text-xs line-through'>
                         MRP : {product.mrp.toLocaleString('en-IN', {style: 'currency', currency: 'INR'})}
                     ...
                     <td className='md:table-cell flex justify-between md:p-3 px-3 pb-2'>
                        <span className='md:hidden font-medium'>Quantity</span>
                          <div className='flex justify-center'>
                              <div className="flex justify-center items-center md:h-10 h-7 border border-amber-700 w-fit rounded-full">
                    ...
                    <td className=' md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center'>
                      ...
                      <button type='button' onClick={()=>dispatch(removeFromCart({
                        productId: product.productId , variantId : product.variantId
                      }))}>
                    ...
                    <table className='w-full'>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td className='text-end py-2 text-red-600'>
                        ...
                        <tr>
                          ...
                          <td className='text-end py-2 text-amber-900 font-semibold'>
                            {subtotal.toLocaleString('en-IN', {style : 'currency', currency: 'INR'})}
                          </td>
