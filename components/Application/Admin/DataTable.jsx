...
const DataTable = ({
  ...
  // Filter, sorting and pagination states
    ...
    const handleDelete = (ids , deleteType)=>{
      ...
      if(deleteType === 'PD'){
        c = confirm('Are you sure that you want to delete the data permanently?');

      }else{
        c = confirm('Are you sure that you want to move the data into trash?');
      }
      if(c){
    ...
    renderTopToolbarCustomActions : ({table})=>(
      <Tooltip>
        <ButtonLoading
          type="button"
          text={<><FileDownloadOutlinedIcon fontSize='33' /> Export</>}
