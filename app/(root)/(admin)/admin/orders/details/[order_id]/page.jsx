      ...
      <div className="border">
        {!orderData ? 
          ...
          <div className="flex justify-center items-center py-32">
            <h4 className="text-red-700 dark:text-amber-500 text-xl font-semibold">Order Not Found!</h4>
          </div>
            :
            ...
            <div className="">
                ...
                <div className="py-2 px-5 border-b mb-3">
                  <h4 className="text-lg font-bold text-amber-900 dark:text-amber-600">Order Details</h4>
                </div>
                ...
                <div className="px-5 mb-5">
                  ...
                  <div className="mb-5">
                    ...
                    <p className="captalize"><b>Status : </b>{orderData?.status}</p>
                  </div>
                        ...
                        {orderData && orderData?.products?.map((product)=>(
                          <tr key={product.variantId._id} className="md:table-row block border-b">
                                ...
                                <div className="flex items-center gap-5">
                                  ...
                                  <div>
                                      <h4 className="text-lg ">
                                        <Link className="text-amber-900 dark:text-amber-500 font-semibold" href={WEBSITE_PRODUCT_DETAILS(product?.productId?.slug)}>{product?.productId?.name}</Link>
                                      </h4>
                                        <p className="text-xm">Color : {product?.variantId?.color}</p>
                                        <p className="text-xm">Size : {product?.variantId?.size}</p>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center">
                                ...
                                <span>{product.sellingPrice.toLocaleString('en-IN' , {
                              ...
                              <td className="md:table-cell flex justify-between md:p-3 px-3 pb-2 text-center">
                                ...
                                <span>{(product.qty * product.sellingPrice).toLocaleString('en-IN' , {
                                  style:'currency', currency : 'INR'
                                })}</span>
                  ...
                  <div className="grid md:grid-cols-2 grid-cols-1 gap-10 border mt-10">
                          ...
                          {/* shipping address */}
                        <div className="p-5">
                          <h4 className="text-lg font-bold text-amber-900 dark:text-amber-500 mb-5">Shipping Address</h4>
                          <div>
                        ...
                        <div className="p-5 bg-gray-50 dark:bg-card">
                          <h4 className="text-lg font-bold text-amber-900 dark:text-amber-500 mb-5">Order Summary</h4>
                          <div>
                            ...
                            <table className="w-full">
                              <tbody>
                                  <tr>
                                    ...
                                    <td className="text-end py-2 ">{orderData?.subtotal.toLocaleString('en-IN' , {
                                                                      style:'currency', currency : 'INR'
                                                                    })}
                                    </td>
                                  </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td className="text-end py-2 text-red-700 dark:text-red-400">-{orderData?.discount.toLocaleString('en-IN' , {
                                                                      style:'currency', currency : 'INR'
                                                                    })}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td className="text-end py-2 ">{orderData?.couponDiscountAmount.toLocaleString('en-IN' , {
                                                                      style:'currency', currency : 'INR'
                                                                    })}
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td className="text-end py-2 font-bold text-amber-900 dark:text-amber-500">{orderData?.totalAmount.toLocaleString('en-IN' , {
                                                                      style:'currency', currency : 'INR'
                                                                    })}
                                    </td>
                                  </tr>
                          ...
                          <div className="mt-3">
                                <h4 className="mb-3 text-xl font-bold text-amber-900 dark:text-amber-600">Order Status</h4>
                                ...
                                <ButtonLoading type="button" loading={updatingStatus} onClick={handleOrderStatus} text="Save Status" className="mt-5 bg-amber-900 dark:bg-amber-600 cursor-pointer" />
                          </div>
                        </div>
                  </div>
