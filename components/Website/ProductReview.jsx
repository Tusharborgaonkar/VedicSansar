  ...
  return (
    <div className="shadow rounded border mb-20">
              <div className="p-3 bg-gray-50 border-b">
                  <h2 className="font-semibold text-2xl text-amber-800">Rating & Reviews </h2>
              </div>
                ...
                <div className="p-5">
                    ...
                    {isReview && 
                        <div className='my-6'>
                            <hr className='mb-5' />
                            <h4 className='text-xl font-semibold text-amber-800 mb-3'>Write a Review</h4>
                            {!auth ? 
                            ...
                            <>
                                ...
                                <>
                                    ...
                                    <form onSubmit={form.handleSubmit(handleReviewSubmit)} >
                                        ...
                                        <div className='mb-3'>
                                            <ButtonLoading loading={loading} type="submit" text = "Submit Review" className='text-xm text-white font-semibold cursor-pointer bg-amber-800 hover:bg-amber-700' />
                                        </div>
                    ...
                    <div className='mt-10 border-t pt-5'>
                        ...
                        <div className='mt-10'>
                            ...
                            {hasNextPage && 
                                <ButtonLoading  type="button" text = "Load More" loading={isFetching} onClick={fetchNextPage} className='text-xm text-white font-semibold cursor-pointer bg-amber-800 hover:bg-amber-700' />
                            }
                        </div>
